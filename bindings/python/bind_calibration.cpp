...
void bind_calibration(py::module_& m)
{
    ...
    py::class_<dic::StereoCalibrationOptions>(sub, "StereoCalibrationOptions")
        ...
        .def_readwrite("reject_outlier_pairs", &dic::StereoCalibrationOptions::reject_outlier_pairs)
        .def_readwrite("outlier_mad_factor", &dic::StereoCalibrationOptions::outlier_mad_factor)
        .def_readwrite("left_right_error_ratio_threshold", &dic::StereoCalibrationOptions::left_right_error_ratio_threshold)
        .def_readwrite("left_right_error_abs_threshold", &dic::StereoCalibrationOptions::left_right_error_abs_threshold)
        .def_readwrite("min_pairs_after_rejection", &dic::StereoCalibrationOptions::min_pairs_after_rejection)
    ...
    py::class_<dic::StereoCalibrationResult>(sub, "StereoCalibrationResult")
        ...
        .def_readwrite("per_pair_left_errors", &dic::StereoCalibrationResult::per_pair_left_errors)
        .def_readwrite("per_pair_right_errors", &dic::StereoCalibrationResult::per_pair_right_errors)
        .def_readwrite("initial_per_pair_errors", &dic::StereoCalibrationResult::initial_per_pair_errors)
        .def_readwrite("initial_per_pair_left_errors", &dic::StereoCalibrationResult::initial_per_pair_left_errors)
        .def_readwrite("initial_per_pair_right_errors", &dic::StereoCalibrationResult::initial_per_pair_right_errors)
        .def_readwrite("kept_pair_indices", &dic::StereoCalibrationResult::kept_pair_indices)
        .def_readwrite("rejected_pair_indices", &dic::StereoCalibrationResult::rejected_pair_indices)
        .def_readwrite("rejection_reasons", &dic::StereoCalibrationResult::rejection_reasons)
        ...
        .def_readwrite("initial_rms_error", &dic::StereoCalibrationResult::initial_rms_error)
        .def_readwrite("outlier_rejection_applied", &dic::StereoCalibrationResult::outlier_rejection_applied);
    ...
    py::class_<dic::MultiviewCalibrationOptions>(sub, "MultiviewCalibrationOptions")
        ...
        .def_readwrite("matching_window", &dic::MultiviewCalibrationOptions::matching_window)
        .def_readwrite("wrap_matching", &dic::MultiviewCalibrationOptions::wrap_matching)
        .def_readwrite("initial_image1", &dic::MultiviewCalibrationOptions::initial_image1)
        .def_readwrite("initial_image2", &dic::MultiviewCalibrationOptions::initial_image2)
        .def_readwrite("initial_focal_length_factor", &dic::MultiviewCalibrationOptions::initial_focal_length_factor)
        .def_readwrite("abs_pose_max_error", &dic::MultiviewCalibrationOptions::abs_pose_max_error)
        .def_readwrite("abs_pose_min_num_inliers", &dic::MultiviewCalibrationOptions::abs_pose_min_num_inliers)
        .def_readwrite("abs_pose_min_inlier_ratio", &dic::MultiviewCalibrationOptions::abs_pose_min_inlier_ratio)
        .def_readwrite("filter_max_reproj_error", &dic::MultiviewCalibrationOptions::filter_max_reproj_error)
        .def_readwrite("ba_local_num_images", &dic::MultiviewCalibrationOptions::ba_local_num_images)
        .def_readwrite("ignore_two_view_tracks", &dic::MultiviewCalibrationOptions::ignore_two_view_tracks)
        .def_readwrite("refine_bundle", &dic::MultiviewCalibrationOptions::refine_bundle)
        .def_readwrite("refine_focal_length", &dic::MultiviewCalibrationOptions::refine_focal_length)
        .def_readwrite("refine_principal_point", &dic::MultiviewCalibrationOptions::refine_principal_point)
        .def_readwrite("refine_extra_params", &dic::MultiviewCalibrationOptions::refine_extra_params)
        .def_readwrite("share_intrinsics", &dic::MultiviewCalibrationOptions::share_intrinsics)
