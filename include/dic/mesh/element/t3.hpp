/**
 * @file t3.hpp
 * @brief T3Element shape function skeleton.
 *
 * Responsibilities:
...
#ifndef TRADITIONAL_DIC_INCLUDE_DIC_MESH_ELEMENT_T3_HPP
#define TRADITIONAL_DIC_INCLUDE_DIC_MESH_ELEMENT_T3_HPP

#include <dic/mesh/element/element.hpp>

namespace dic {

class T3Element : public Element { public: int node_count() const override; Eigen::VectorXd shape_functions(double xi, double eta) const override; Eigen::MatrixXd shape_function_derivatives(double xi, double eta) const override; };

} // namespace dic

#endif // TRADITIONAL_DIC_INCLUDE_DIC_MESH_ELEMENT_T3_HPP
