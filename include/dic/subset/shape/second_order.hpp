 ...
 * @brief SecondOrderShapeFunction warp model.
 *
 * Responsibilities:
...
#ifndef TRADITIONAL_DIC_INCLUDE_DIC_SUBSET_SHAPE_SECOND_ORDER_HPP
#define TRADITIONAL_DIC_INCLUDE_DIC_SUBSET_SHAPE_SECOND_ORDER_HPP

#include <dic/subset/shape/shape_function.hpp>

namespace dic {

class SecondOrderShapeFunction : public ShapeFunction {
public:
...
#endif // TRADITIONAL_DIC_INCLUDE_DIC_SUBSET_SHAPE_SECOND_ORDER_HPP
