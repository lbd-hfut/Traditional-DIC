/**
 * @file sift_initializer.cpp
 * @brief Minimal implementation placeholder for sift_initializer.
 *
 * Responsibilities:
...
SIFTInitializer::SIFTInitializer(int search_radius) : search_radius_(search_radius) {}
InitialDisplacement SIFTInitializer::estimate(const Image& reference, const Image& deformed, const Eigen::Vector2d& point) const { (void)reference; (void)deformed; (void)point; return {0.0, 0.0, 0.0, false}; }
