/**
 * @file zncc.cpp
 * @brief Minimal implementation placeholder for zncc.
 *
 * Responsibilities:
...
double ZNCCCorrelation::evaluate(const Eigen::VectorXd& reference, const Eigen::VectorXd& deformed) const { (void)reference; (void)deformed; throw std::runtime_error("Not implemented yet."); }
