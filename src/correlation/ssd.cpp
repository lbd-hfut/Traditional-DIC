/**
 * @file ssd.cpp
 * @brief Minimal implementation placeholder for ssd.
 *
 * Responsibilities:
...
double SSDCorrelation::evaluate(const Eigen::VectorXd& reference, const Eigen::VectorXd& deformed) const { (void)reference; (void)deformed; throw std::runtime_error("Not implemented yet."); }
